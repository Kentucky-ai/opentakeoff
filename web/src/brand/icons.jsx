...
export const icons = {
  ...
  risk: (s) => <I size={s}><path d="M12 3 L 22 20 H 2 Z" /><line x1="12" y1="10" x2="12" y2="15" /><circle cx="12" cy="18" r="0.8" fill="currentColor" /></I>,
  agent: (s) => <I size={s}><circle cx="12" cy="9" r="3.5" /><path d="M5 21 V 19 a 7 7 0 0 1 14 0 V 21" /><path d="M16 7 L 18 5 M 8 7 L 6 5" /></I>,
  audit: (s) => <I size={s}><rect x="3" y="3" width="18" height="18" /><path d="M7 12 L 10 15 L 17 8" /></I>,
  field: (s) => <I size={s}><path d="M12 3 V 21" /><circle cx="12" cy="9" r="3" /><path d="M9 19 H 15" /></I>,
  ...
  search: (s) => <I size={s}><circle cx="10" cy="10" r="6" /><line x1="14.5" y1="14.5" x2="20" y2="20" /></I>,
  settings: (s) => <I size={s}><circle cx="12" cy="12" r="3" /><path d="M12 3 V 6 M12 18 V 21 M3 12 H 6 M18 12 H 21 M5.5 5.5 L 7.5 7.5 M16.5 16.5 L 18.5 18.5 M5.5 18.5 L 7.5 16.5 M16.5 7.5 L 18.5 5.5" /></I>,
  ...
  scaleRule: (s) => <I size={s}><rect x="2.5" y="9" width="19" height="6" /><path d="M6.5 9 V 12 M10.5 9 V 13.8 M14.5 9 V 12 M18.5 9 V 13.8" /></I>,
  ...
  fit: (s) => <I size={s}><path d="M4 8 V 4 H 8 M16 4 H 20 V 8 M20 16 V 20 H 16 M8 20 H 4 V 16" /></I>,
  zoomIn: (s) => <I size={s}><circle cx="10" cy="10" r="6" /><line x1="14.5" y1="14.5" x2="20" y2="20" /><path d="M10 7.5 V 12.5 M7.5 10 H 12.5" /></I>,
  zoomOut: (s) => <I size={s}><circle cx="10" cy="10" r="6" /><line x1="14.5" y1="14.5" x2="20" y2="20" /><path d="M7.5 10 H 12.5" /></I>,
  ...
  flag: (s) => <I size={s}><line x1="6" y1="3" x2="6" y2="21" /><path d="M6 4 H 18 L 15 8 L 18 12 H 6" /></I>,
