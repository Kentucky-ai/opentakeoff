...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-26 (commit 90f37f6)
...
- `web/src/pages/TakeoffCanvas.jsx` — 37 bug fixes, last fix today (bug magnet); 162 commits/90d
- `web/src/components/ReportPanel.jsx` — 12 bug fixes, last fix today (bug magnet); 51 commits/90d
- `web/src/components/TakeoffsPanel.jsx` — 7 bug fixes, last fix today (bug magnet); 25 commits/90d
- `mcp/src/session.ts` — 8 bug fixes, last fix 4 weeks ago (bug magnet); 53 commits/90d
- `web/netlify/functions/parse-schedule.mjs` — 8 bug fixes, last fix 4 weeks ago (bug magnet); 10 commits/90d

### Code health
Three co-equal signals: defect risk 7.28/10 avg, hotspot health 6.01/10 (stable), worst `web/src/pages/TakeoffCanvas.jsx` at 2.38/10 · maintainability 8.17/10 · performance risk 40 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

Critical files:
- `web/src/pages/TakeoffCanvas.jsx` — prior defect — impact −2.0
- `web/public/locales/pt-br/panels.json` — prior defect — impact −2.0
- `web/test/i18n-lang.test.ts` — prior defect — impact −2.0
- `web/src/components/ReportPanel.jsx` — prior defect — impact −2.0
- `web/public/locales/en/panels.json` — prior defect — impact −2.0
