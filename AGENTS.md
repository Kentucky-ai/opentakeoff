...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-25 (commit 9512409)
...
- `web/src/pages/TakeoffCanvas.jsx` — 39 bug fixes, last fix today (bug magnet); 167 commits/90d
- `web/src/components/ReportPanel.jsx` — 13 bug fixes, last fix today (bug magnet); 53 commits/90d
- `web/src/components/TakeoffsPanel.jsx` — 9 bug fixes, last fix today (bug magnet); 28 commits/90d
- `web/test/unitSystemGlobal.test.ts` — 7 bug fixes, last fix today (bug magnet); 8 commits/90d
- `mcp/src/session.ts` — 8 bug fixes, last fix 4 weeks ago (bug magnet); 53 commits/90d

### Code health
Three co-equal signals: defect risk 7.44/10 avg, hotspot health 5.63/10 (stable), worst `web/src/lib/oneclick.ts` at 3.01/10 · maintainability 8.23/10 · performance risk 46 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

Critical files:
- `web/src/pages/TakeoffCanvas.jsx` — prior defect — impact −2.0
- `web/test/units.test.ts` — prior defect — impact −2.0
- `web/test/unitSystemGlobal.test.ts` — prior defect — impact −2.0
- `web/test/unitPreference.test.ts` — prior defect — impact −2.0
- `web/test/totals.test.ts` — prior defect — impact −2.0
