...
| 4. Repository/package boundaries | In progress: [dependency map and first extraction candidate](design/PACKAGE_BOUNDARIES.md) | Clarify extraction, package ownership and release boundaries after the current source/package guards are measured. |
