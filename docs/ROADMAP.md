...
| Release versions | Published: `opentakeoff-mcp` 0.9.85 (npm, Registry, hosted manifest, desktop bundle). Source: 0.9.86 on `main` with the packaged tracing rules, not yet tagged or published. Web package 0.1.0, independent. | [changelog](../CHANGELOG.md), [deployment](DEPLOYMENT.md) |
